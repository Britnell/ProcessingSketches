...
void send_rgb_vals()
{
  for( int i=0; i<NMPXL; i++)
  {
    ...
    ardPort.write( red[   wrap_index(i-this_drag-drag_dist,NMPXL) ] );
    ardPort.write( green[ wrap_index(i-this_drag-drag_dist,NMPXL) ] );
    ardPort.write( blue[  wrap_index(i-this_drag-drag_dist,NMPXL) ] );
  }
  ardPort.write(10);
