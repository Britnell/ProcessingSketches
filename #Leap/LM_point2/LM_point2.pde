...
void draw() {
  ...
  for (Hand hand : leap.getHands ()) {
    ...
    for (Finger finger : hand.getOutstretchedFingers()  ) {
      ...
      stroke( 30, 160, 30);        fill( col );
      ellipse( handPosition.x, handPosition.y, 40, 40);
      
      float angle = atan2(fingerDirection.z, fingerDirection.x );
      println( "anlge ", angle ," , " );
      
      // finger Stabilized
          // I like x and y, but z seems very laggy
      //System.out.print("  tips stable ");     System.out.println( fingerStabilized);
      //System.out.print("  tips ");     System.out.println( fingerPosition);
