...
class TheJig
{
    ...
    PShape get_tmp_trig_fixed(int id1, int id2)
    {
        // --drawing mode
        // draw temp triangle
        
        PVector clos = jigs.getVertex(id1);
        PVector neighb = jigs.getVertex(id2);
    ...
    void add_point_fixed(float X, float Y, int cl, int nb)
    {
    ...
    */
    ...
    float[] get_closest_aray(PShape shop, float X, float Y)
    {     
      float c_dist = -1;
      int closest_v = 0;
